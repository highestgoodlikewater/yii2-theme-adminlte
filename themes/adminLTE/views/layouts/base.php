                                ...
                                <li class="dropdown user user-menu">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="user-header">
                                            ...
                                            <?php if(\Yii::$app->user->isGuest): ?>
                                                <p>Guest - Administration<small>Member since Nov. 2012</small></p>
                                            <?php else: ?>
                                                <p><?php echo ucfirst(Yii::$app->user->identity->username); ?> - Administration<small>Member since Nov. 2012</small></p>
                                            <?php endif; ?>
                                        </li>
                                        <li class="user-body">
